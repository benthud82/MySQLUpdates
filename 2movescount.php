...
$tbl_name = "slotting.2moves"; // Table name
...
$result = $aseriesconn->prepare("SELECT MVTITM, MVTPKG, MVFZNE, MVTZNE, MVTYPE, MVREQD as DATE,  MVREQT FROM A.HSIPCORDTA.NPFMVE WHERE (MVTPKG <> 0) and MVCNFQ<>0 and (MVDESC like 'COMPLETED%' or MVDESC like 'MAN%') and MVWHSE = 2 and MVREQD >= $startdate");
$result->execute();
