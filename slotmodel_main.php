...
$sqldelete = "DELETE FROM slotting.slotmodel_my_npfmvc WHERE WAREHOUSE = $whssel and PACKAGE_TYPE in ('LSE', 'INP')";
...
include 'slotmodel_L06update.php';

include 'slotmodel_L01update.php';

include 'slotmodel_L02update.php';

include 'slotmodel_L05update.php';

include 'slotmodel_L04update.php';
